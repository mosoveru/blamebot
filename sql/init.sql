...
1	1749049920094	InitDatabase1749049920094
\.
...
ALTER TABLE ONLY public.subscriptions
    ADD CONSTRAINT "FK_94304a1614c818d53db55ae9a72" FOREIGN KEY ("instanceId", "instanceUserId") REFERENCES public.instance_users("instanceId", "instanceUserId");
